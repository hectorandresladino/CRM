...
public class AuthV1Controller {
    ...
    public ResponseEntity<?> registerTenant(@RequestBody AuthService.TenantRegistrationRequest request) {
        try {
            AuthService.AuthResponse response = authService.registerTenant(request);
